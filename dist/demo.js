    ...
    try {
        ...
        if (sampleNewsletter) {
            ...
            const sampleStructure = {
                ...
                metadata: {
                    ...
                    publicationDate: typeof sampleNewsletter.receivedDate === 'string' ? 
                                    sampleNewsletter.receivedDate : 
                                    (sampleNewsletter.receivedDate instanceof Date ? 
                                    sampleNewsletter.receivedDate.toISOString() : 
        ...
        if (mediumConfidenceNewsletters.length > 0) {
            ...
            if (updatedNewsletter) {
                ...
                output.printComparison('Detection Confidence', originalConfidence.toFixed(4), updatedNewsletter.detectionConfidence.toFixed(4), true);
        ...
        output.printComparison('Detection Accuracy', (feedbackStats.accuracyBefore * 100).toFixed(1) + '%', (feedbackStats.accuracyAfter * 100).toFixed(1) + '%', true);
